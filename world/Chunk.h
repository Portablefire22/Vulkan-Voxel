...
class Chunk
{
  public:
    ...
    {
        if (this->ChunkPosition.x == other.ChunkPosition.x &&
            this->ChunkPosition.y == other.ChunkPosition.y &&
            this->ChunkPosition.z == other.ChunkPosition.z)
            return true;
        return false;
    }
    struct HashFunction
...
void
IndexToVec(int index, glm::vec3* blockPosition);
} // chunk
