...
// Functions
static const char*
ImGui_ImplSDL3_GetClipboardText(void*)
{
...
static void
ImGui_ImplSDL3_SetClipboardText(void*, const char* text)
{
    SDL_SetClipboardText(text);
}

static void
ImGui_ImplSDL3_SetPlatformImeData(ImGuiViewport*, ImGuiPlatformImeData* data)
{
    if (data->WantVisible) {
        SDL_Rect r;
...
static ImGuiKey
ImGui_ImplSDL3_KeycodeToImGuiKey(int keycode)
{
    switch (keycode) {
        case SDLK_TAB:
            return ImGuiKey_Tab;
...
static void
ImGui_ImplSDL3_UpdateKeyModifiers(SDL_Keymod sdl_key_mods)
{
...
static void
ImGui_ImplSDL3_SetupPlatformHandles(ImGuiViewport* viewport, SDL_Window* window)
{
    IM_UNUSED(window);
...
static bool
ImGui_ImplSDL3_Init(SDL_Window* window,
                    SDL_Renderer* renderer,
                    void* sdl_gl_context)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool
ImGui_ImplSDL3_InitForOpenGL(SDL_Window* window, void* sdl_gl_context)
{
...
bool
ImGui_ImplSDL3_InitForD3D(SDL_Window* window)
{
#if !defined(_WIN32)
...
bool
ImGui_ImplSDL3_InitForSDLRenderer(SDL_Window* window, SDL_Renderer* renderer)
{
