...
// Functions
static void
ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
...
ImGui_ImplDX9_CreateFontsTexture()
{
    ...
    if (bd->pd3dDevice->CreateTexture(width,
                                      height,
                                      1,
                                      D3DUSAGE_DYNAMIC,
                                      D3DFMT_A8R8G8B8,
