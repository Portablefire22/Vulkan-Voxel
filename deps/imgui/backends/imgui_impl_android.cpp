...
static ImGuiKey
ImGui_ImplAndroid_KeyCodeToImGuiKey(int32_t key_code)
{
    switch (key_code) {
        case AKEYCODE_TAB:
            return ImGuiKey_Tab;
                ...
                case AKEY_EVENT_ACTION_UP: {
                    ...
                    if (key != ImGuiKey_None &&
                        ...
                        io.SetKeyEventNativeData(
                          key, event_key_code, event_scan_code);
                    }
...
bool
ImGui_ImplAndroid_Init(ANativeWindow* window)
{
    g_Window = window;
    g_Time = 0.0;
