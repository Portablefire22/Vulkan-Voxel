...
// Functions
static const char*
ImGui_ImplSDL2_GetClipboardText(void*)
{
...
static void
ImGui_ImplSDL2_SetClipboardText(void*, const char* text)
{
...
static void
ImGui_ImplSDL2_SetPlatformImeData(ImGuiViewport*, ImGuiPlatformImeData* data)
{
    if (data->WantVisible) {
        SDL_Rect r;
...
static ImGuiKey
ImGui_ImplSDL2_KeycodeToImGuiKey(int keycode)
{
    switch (keycode) {
        case SDLK_TAB:
            return ImGuiKey_Tab;
...
static void
ImGui_ImplSDL2_UpdateKeyModifiers(SDL_Keymod sdl_key_mods)
{
...
static bool
ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool
ImGui_ImplSDL2_InitForOpenGL(SDL_Window* window, void* sdl_gl_context)
{
...
bool
ImGui_ImplSDL2_InitForVulkan(SDL_Window* window)
{
#if !SDL_HAS_VULKAN
...
bool
ImGui_ImplSDL2_InitForOther(SDL_Window* window)
{
    return ImGui_ImplSDL2_Init(window, nullptr);
}
...
#define MAP_ANALOG(KEY_NO, AXIS_NO, V0, V1)                                    \
    ...
    MAP_ANALOG(
      ImGuiKey_GamepadL2, SDL_CONTROLLER_AXIS_TRIGGERLEFT, 0.0f, 32767);
    MAP_ANALOG(
      ImGuiKey_GamepadR2, SDL_CONTROLLER_AXIS_TRIGGERRIGHT, 0.0f, 32767);
