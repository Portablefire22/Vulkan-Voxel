...
// Functions
static void
ImGui_ImplDX11_SetupRenderState(ImDrawData* draw_data, ID3D11DeviceContext* ctx)
{
    ...
    ctx->HSSetShader(
      nullptr, nullptr, 0); // In theory we should backup and restore this as
...
ImGui_ImplDX11_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // is (0,0) for single viewport apps.
    {
        ...
        if (ctx->Map(bd->pVertexConstantBuffer,
                     0,
...
ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        // Create the constant buffer
        {
            ...
            desc.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
            desc.MiscFlags = 0;
            bd->pd3dDevice->CreateBuffer(
              &desc, nullptr, &bd->pVertexConstantBuffer);
        }
    }
